...
public class Users {
    ...
    private String active_acc;

    public Users(String fsm_sub, String position, String place_job, String subdivision, String phone_sub, String s, String post_address, Boolean active_acc) {
    }
    ...
    public String getActive_acc() {
        return active_acc;
    }

    public void setActive_acc(String active_acc) {
        this.active_acc = active_acc;
    }

    public Users(String fsm_sub, String position, String place_job, String subdivision, String phone_sub, String post_address, String role_sub, String active_acc) {
